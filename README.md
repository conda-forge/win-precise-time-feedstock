About win-precise-time-feedstock
================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/win-precise-time-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/win-precise-time-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add win-precise-time
# for installing globally
pixi global install win-precise-time
```
...
It is possible to list all of the versions of `win-precise-time` available on your platform:
...
```
pixi search win-precise-time --channel conda-forge
```
